...
var httpTokenClientOptions = new TokenClientOptions { ClientId = "petrosyan", ClientSecret = "secret" };

TokenClient tokenClient = new TokenClient(httpTokenClient, httpTokenClientOptions);

var tokenResponse = await tokenClient.RequestPasswordTokenAsync("Test", "P@ssword1", "bankOfDotNetApi");
...
var customerInfo = new StringContent(JsonConvert.SerializeObject(new { FirstName = "Bob", LastName = "Jackson" }), Encoding.UTF8, "application/json");
